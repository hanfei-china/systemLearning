...
function citiesToObject(cityList){
    let obj = {};
    for(let city of cityList){
        let {children,code,name,lat,lng} = city;
        ...
        if(children && children.length > 0){
            _city.children = citiesToObject(children);
        }
...
export const citiesObject = citiesToObject(cities);

export function getMapData(data, provinceName){
    let result = [];
    ...
    if(provinceName){
        ...
        for(let item of data){
            let {name,cityIndex,enumIndex,isOther,value,code} = item;

            let city = citiesObject[name];
            ...
            if(city){
                ...
                result.push({
                    name,cityIndex,enumIndex,isOther,code,
                    value: [lng,lat,value]
                });
            }
