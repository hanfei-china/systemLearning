...
export default class HomeSimpleTextBanner extends Module{

    constructor(config){
        super('homeSimpleTextBanner');

        let title, titleColor, titleIcon, titleIconPosition, funcType, listStyle,
            contentClass, queryMode, dataMaxCount, isLoadByBranchId;

        title = new Attribute('textAttr','文字轮播')
            .addAttributes({
                title: '功能标题',
