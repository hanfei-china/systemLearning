 ...
 * 图文排列组件
 */
export default class HomeImageRankList extends Module{

    constructor(config){
        super('homeImageRankList');

        let title, titleColor, titleIcon, titleIconPosition, funcType, listStyle, contentClass, queryMode, dataMaxCount, defaultImg, isLoadByBranchId;

        title = new Attribute('textAttr','图片列表-排列')
            .addAttributes({
                title: '功能标题',
        ...
        titleColor = new Attribute('colorAttr', '#13B2FF')
            .addAttributes({
                title: '标题字体颜色',
                showAlpha: false,
                showClear: false,
        ...
        let attributes = {title, titleColor, titleIcon, titleIconPosition, funcType, listStyle, contentClass, queryMode, dataMaxCount, defaultImg, isLoadByBranchId};
