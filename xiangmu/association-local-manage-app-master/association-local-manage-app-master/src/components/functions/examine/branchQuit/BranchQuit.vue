...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getList(){
                this.$request.get('/api/admin/branchManage/getQuitBranchApplies',{params:this.condition}).then(resp=>{
            ...
            agree(id){
                this.$request.post('/api/admin/branchManage/approvalQuitBranchApply',{
                    status: '1',
                    id: id,
                }).then(()=>{
                    this.reloadList();
