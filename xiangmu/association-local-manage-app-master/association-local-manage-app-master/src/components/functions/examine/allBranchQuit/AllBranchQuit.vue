...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getList(){
                this.$request.get('/api/admin/branchManage/getQuitAllBranchApply',{params:this.condition}).then(resp=>{
            ...
            agree(id){
                this.$request.post('/api/admin/branchManage/approvalQuitAllBranchApply',{
                    status: '1',
                    id: id,
                }).then(()=>{
                    this.reloadList();
