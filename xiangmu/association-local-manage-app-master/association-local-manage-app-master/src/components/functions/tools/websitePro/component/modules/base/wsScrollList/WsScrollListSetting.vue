...
<template>
    <setting-container ref="setting" :width.sync="module.attributes.layoutGroup.attributes.layout.value.width"
        ...
        <ws-scroll-list class="lrd-dom-drag" :module="module" design/>
    </setting-container>
</template>

<script>
    import SettingContainer from "../../SettingContainer";
    import WsScrollList from "./WsScrollList";
    export default {
        name: "WsScrollListSetting",
        components: {WsScrollList, SettingContainer},
        props:{
            module: Object,
            canDelete: {
                type: Boolean,
