<template>
    <a draggable="false" class="website-pro-absolute-fill-parent website-pro-flex column center" :href="href" :target="target"
       :style="style" :class="customClasses">{{value}}</a>
</template>
