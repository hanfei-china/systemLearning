        ...
        <el-main class="unset-padding position-relative">
            <el-container class="absolute-fill-parent" style="padding: 20px;" v-if="!sendRecordVisible">
                <el-header class="flex border-bottom" height="auto" style="padding: 0 0 20px;">
                    <div class="flex-fill-in-the-remaining-space" style="line-height: 32px;">发送消息</div>
                    <div>
                ...
                <el-main class="unset-padding border-bottom position-relative">
                    <el-container class="absolute-fill-parent" style="padding-top: 20px;">
                        ...
                        <el-main class="unset-padding position-relative">
                            <template-export :activityId="activityId" v-model="url"></template-export>
                        </el-main>
                    </el-container>
                </el-main>
            ...
            <send-record v-if="sendRecordVisible" :activityId="activityId" @close="sendRecordVisible = false"></send-record>
        </el-main>
    </el-container>
</template>
