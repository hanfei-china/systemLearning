...
<script>
    ...
    import GroupList from "../../../util/group/BranchGroupList";
        ...
        methods: {
            ...
            getInformationList() {
                ...
                if(this.chosenGroup.id !== null && this.chosenGroup.id !== undefined){
                    ...
                    this.$request.post('/api/admin/information/exchange/manage/listInformationExchangeByBranch', params).then(res => {
                        if (res.success) {
