    ...
    <el-container class="absolute-fill-parent">
        <el-header class="unset-padding" height="auto">
            <div style="padding: 8px 10px 0;">
                <el-button style="width: 100%;" type="primary" @click="addButton" size="medium" plain
                           :disabled="ifAddStatus">+添加按钮
                </el-button>
            </div>
        </el-header>
        <el-main class="unset-padding">
            <vue-scroll>
                <div style="padding: 7px 10px;">
                    <draggable v-model="module.children">
                        <module-cover class="button-setting-container-cover" v-for="(module, index) of module.children"
                                      :key="index">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ifAddStatus: false,//超过九个禁止添加
            }
        },
        created() {
            if (this.module.children.length >= 9
            ) {
        ...
        methods: {
            addButton() {
                this.module.addButton();
            }
            ,
            deleteModule(index) {
                this.module.deleteButton(index);
            }
            ,
