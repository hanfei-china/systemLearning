            ...
            <vue-scroll>
                <div style="width: 840px;">
                    <el-form size="small" label-width="110px">
                        ...
                        <el-form-item label="文档课件" required>
                            <el-upload :action="action" :on-success="uploadDocumentSuccess" :show-file-list="false">
                                <el-button type="primary">上传课程文档</el-button>
                            </el-upload>
                            <a v-if="resource" target="_blank" :href="resource">点击查看课程文档</a>
                        </el-form-item>
