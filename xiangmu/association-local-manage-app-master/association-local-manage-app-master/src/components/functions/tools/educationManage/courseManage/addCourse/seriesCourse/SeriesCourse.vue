<template>
    <el-container class="absolute-fill-parent">
        <el-main class="position-relative unset-padding">
            <series-course-catalog v-if="catalogVisible" :basicInfo="basicInfo" :id="id"
                                   @closeWrap="goBack" @close="catalogVisible = false" @refresh="$emit('refresh')"></series-course-catalog>
            <el-container v-else class="absolute-fill-parent">
...
<script>
    import SeriesCourseCatalog from "./SeriesCourseCatalog";
    import {requestBaseUrl} from "../../../../../../../js/config/serviceConfig";

    export default {
        name: "SeriesCourse",
        components: {SeriesCourseCatalog},
        props: {
            id: String
        },
        data(){
