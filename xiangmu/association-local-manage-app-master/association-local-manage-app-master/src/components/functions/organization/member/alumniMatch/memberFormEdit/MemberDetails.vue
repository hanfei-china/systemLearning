        ...
        <div class="fieldbox">
          ...
          <div class="expbox" v-else>
            <div class="rows" v-for="(item,index) in model.studentExperience" :key="index" v-if="studentExperienceFieldCode.length>0">
              ...
              <div class="row2">
                <div v-if="studentExperienceFieldCode.includes('education')">{{item.education}}</div>
                <div v-if="item.major&&studentExperienceFieldCode.includes('major')">{{item.major}}</div>
                <div v-if="item.cless&&studentExperienceFieldCode.includes('cless')">{{item.cless}}</div>
                <div v-if="item.studentNo&&studentExperienceFieldCode.includes('studentNo')">{{item.studentNo}}</div>
              </div>
            </div>
            <div class="rows" v-for="(item,index) in model.teacherExperience" :key="item.id" v-if="teacherExperienceFieldCode.length>0">
              ...
              <div class="row2">
                <div v-if="item.job&&teacherExperienceFieldCode.includes('job')">{{item.job}}</div>
                <div v-if="item.jobNo&&teacherExperienceFieldCode.includes('jobNo')">{{item.jobNo}}</div>
              </div>
            </div>
          </div>
        </div>
...
export default {
  name: "MemberForm",
  components: {
    MemberGroupMultiTree,
    AllMemberFieldChoose,
    MemberEditFieldNew,
    CityChoose,
  },
  props: {
